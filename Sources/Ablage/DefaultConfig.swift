    ...
    static let json = #"""
{
  "_help": [
    ...
    "  minAgeDays, minSizeMB, maxSizeMB",
    ...
    "learning: Apply rule in the panel teaches the app. Later files that look like a taught one",
    "  get the same rule on their own, marked (learned). Undo teaches the opposite.",
